...
pub use copilot_identity::{
    apply_copilot_client_identity, COPILOT_API_VERSION, COPILOT_EDITOR_PLUGIN_VERSION,
    COPILOT_EDITOR_VERSION, COPILOT_INTEGRATION_ID, COPILOT_TOKEN_URL, COPILOT_USER_AGENT,
};
